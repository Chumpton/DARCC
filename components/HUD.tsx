      ...
      <DraggableItem id="potionBar" position={positions.potionBar} onMove={handleMove} onScale={handleScale} isLocked={!isEditMode}>
        <div className="flex flex-col gap-2 pointer-events-auto">
            ...
            >
                ...
                <span className="absolute -top-2 -left-2 bg-gray-900 border border-gray-600 text-gray-300 text-[10px] w-5 h-5 flex items-center justify-center rounded-full font-mono">1</span>
            ...
            >
                ...
                <span className="absolute -top-2 -left-2 bg-gray-900 border border-gray-600 text-gray-300 text-[10px] w-5 h-5 flex items-center justify-center rounded-full font-mono">2</span>
            ...
            >
                ...
                <span className="absolute -top-2 -left-2 bg-gray-900 border border-gray-600 text-gray-300 text-[10px] w-5 h-5 flex items-center justify-center rounded-full font-mono">3</span>
      ...
      <DraggableItem id="actionDock" position={positions.actionDock} onMove={handleMove} onScale={handleScale} isLocked={!isEditMode}>
            <div className="flex flex-col items-end gap-1">
                ...
                <div className="flex flex-col items-center group cursor-pointer relative">
                    ...
                    <div className="absolute top-1 left-1 text-[10px] text-gray-500 font-mono">Q</div>
                </div>
                <div className="flex flex-col items-center group cursor-pointer relative">
                    ...
                    <div className="absolute top-1 left-1 text-[10px] text-gray-500 font-mono">W</div>
                </div>
                <div className="flex flex-col items-center group cursor-pointer relative">
                    ...
                    <div className="absolute top-1 left-1 text-[10px] text-gray-500 font-mono">E</div>
                </div>
                <div className="flex flex-col items-center group cursor-pointer relative">
                    ...
                    <div className="absolute top-1 left-1 text-[10px] text-gray-500 font-mono">R</div>
                </div>
                {/* Row 2 */}
                <div className="flex flex-col items-center group cursor-pointer relative">
                    ...
                    <div className="absolute top-1 left-1 text-[10px] text-gray-500 font-mono">T</div>
                </div>
                <div className="flex flex-col items-center group cursor-pointer relative">
                    ...
                    <div className="absolute top-1 left-1 text-[10px] text-gray-500 font-mono">Y</div>
                </div>
                <div className="flex flex-col items-center group cursor-pointer relative">
                    ...
                    <div className="absolute top-1 left-1 text-[10px] text-gray-500 font-mono">U</div>
                </div>
                <div className="flex flex-col items-center group cursor-pointer relative">
                    ...
                    <div className="absolute top-1 left-1 text-[10px] text-gray-500 font-mono">I</div>
                </div>
